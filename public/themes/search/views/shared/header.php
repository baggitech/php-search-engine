...
defined('FIR') OR exit();
/**
 * Template para exibição da seção Header (cabeçalho)
 * 
 * Este arquivo define a estrutura do cabeçalho do site, incluindo:
 * - Aviso de política de cookies (se configurado)
 * - Logo do site (com suporte a tema claro/escuro)
 * - Barra de busca (na página inicial)
 * - Menu de navegação principal
 * - Menu dropdown de preferências
 * 
 * Funcionalidades:
 * - Adapta o logo baseado no tema (claro/escuro)
 * - Exibe aviso de cookies se necessário
 * - Renderiza barra de busca ou menu de busca na home
...
<div id="header" class="header<?php if(!$this->url[0]): ?> header-home<?php endif ?>">
    <?php if($this->settings['cookie_policy_url']): ?>
        ...
        <!-- Container do aviso de política de cookies -->
